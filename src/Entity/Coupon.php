...
class Coupon
{
    ...
    public function getCreadetAt(): ?\DateTimeImmutable
    {
        return $this->creadet_at;
    }

    public function setCreadetAt(\DateTimeImmutable $creadet_at): self
    {
        $this->creadet_at = $creadet_at;
